      ...
      <PixelTable
        ...
        data={[
          ...
          },
          {
            keys: (
              <>
                <PixelKbd>Ctrl</PixelKbd>+<PixelKbd>`</PixelKbd>
              </>
            ),
          ...
          },
          {
            keys: (
              <>
                <PixelKbd>G</PixelKbd> then <PixelKbd>M</PixelKbd>
              </>
            ),
          ...
          },
          {
            keys: (
              <>
                <PixelKbd>G</PixelKbd> then <PixelKbd>S</PixelKbd>
              </>
            ),
          ...
          },
          {
            keys: (
              <>
                <PixelKbd>G</PixelKbd> then <PixelKbd>A</PixelKbd>
              </>
            ),
            action: 'Sessions',
          },
