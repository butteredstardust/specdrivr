...
Master Product Specification - MOVED
...
**This specification has been split into smaller, purpose-specific files.**

Please see [SPECIFICATION_INDEX.md](./SPECIFICATION_INDEX.md) for the complete index of specification documents.

## Quick Links

### Product
- [PRODUCT.md](./PRODUCT.md) - Product overview, vision, user personas

### Technical Architecture
- [ARCHITECTURE.md](./ARCHITECTURE.md) - System architecture and constraints
